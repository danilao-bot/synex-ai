    ...
    <div className="flex flex-col h-full bg-background p-6 overflow-hidden relative">
      ...
      <header className="flex items-center justify-between mb-6 shrink-0">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="bg-success/15 border border-success/30 text-success font-sans font-bold text-xs px-3 py-1.5 rounded-lg flex items-center gap-2 shadow-[0_0_12px_rgba(5,242,155,0.2)]">
